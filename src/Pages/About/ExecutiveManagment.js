    ...
    <div className="">
      ...
      <div className="relative p-3">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="font-semiBold text-4xl text-gray-700">  {isAmh ? 'ከፍተኛ አስተዳደር' :'Top Managment'}</h1>
         <div>
         <div className="max-w-sm md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 py-5 items-center justify-center  ">
           {orderOne?.map((item)=>(
            <div className="flex flex-col items-center w-[100%]  justify-center  shadow-lg">
               <img src={item.managment_photo} alt="" className="h-[300px]  object-cover " />
         ...
         {/* directors */}
         <h1 className="font-semiBold text-4xl text-gray-700">  {isAmh ? 'ዳይሬክተሮች' :'Directors'}</h1>
         <div>
         <div className="max-w-sm md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 py-5 items-center justify-center">
           {orderDirectorOne?.map((item)=>(
            <div className="flex flex-col shadow-lg w-[100%]  items-center justify-center">
               <img src={item.managment_photo} alt="" className="h-[299px] object-cover" />
               <h1 className="font-medium text-gray-700">{isAmh ? item?.name?.amharic : item.name?.english}</h1>
            </div>
           ))}
          </div>
