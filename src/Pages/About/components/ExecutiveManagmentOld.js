      ...
      <div className=" p-3">
        ...
        <div className="max-w-full mx-[4%]">
          ...
          <div className="md:grid-cols-4">
            <div className="max-w-sm md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 py-5 items-center justify-center  ">
              {managementData?.data?.data?.data?.map((item) => (
            ...
            {/* order two */}
            <div className="max-w-xl md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 py-5 items-center justify-center">
              {orderTwo?.map((item) => (
                <div className="flex flex-col  items-left  w-[100%] justify-center shadow-2xl">
                  <img
                    src={item.managment_photo}
                  ...
                  <p className="text-blue-400 pb-4 px-4 text-sm">
            ...
            {/* three */}
            <div className="max-w-2xl md:max-w-[90%] mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 py-5 items-center justify-center">
              {orderThree?.map((item, i) => (
                <div className="flex flex-col items-left w-[100%]  justify-center shadow-2xl">
                  <img
                    src={item.managment_photo}
                    alt=""
